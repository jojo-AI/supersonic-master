...
public class ModelProvider {
    ...
    public static final ChatModelConfig DEMO_CHAT_MODEL =
            ChatModelConfig.builder().provider("OPEN_AI").baseUrl("http://128.23.20.187:63000/v1")
                    .apiKey("sk-8vyMr9yxVcStmdUhDOop9FZhgFqyGioUOStOVkDD6S7zshis")
                    .modelName("deepseek-v4-pro").temperature(0.0).timeOut(60L).build();
